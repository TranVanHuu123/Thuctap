...
const CustomdropdownService = ({ ...props }: Props) => {
  return (
    <div className=" mb-[21px]">
      ...
      <div className="relative w-[160px]  border border-gray rounded-lg bg-white cursor-pointer">
...
export default CustomdropdownService;
